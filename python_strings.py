...
# Example Check if "free" is present in the following
# text:
...
# Slice
# To the End By leaving out the end index, the range will go to the end:
...
# where the text between the specified separator becomes the list items.
